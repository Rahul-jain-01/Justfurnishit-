...
export const registerUser = async (userData: any) => {
  console.log(userData);
    try {
      const response = await axios.post('https://jfi-gngqdwd3dudxh7db.centralindia-01.azurewebsites.net/api/Account/register', {
...
export const loginUser = async (credentials: LoginRequest) => {
    try {
      const response = await axios.post('https://jfi-gngqdwd3dudxh7db.centralindia-01.azurewebsites.net/api/Account/Login', {
